...
static SRV_TASK g_astTaskTbl[] =
{
	...
	{TID_SNIFFER_1, "TEST_SNIFFER_1", sniffer_entry, &g_astTaskTbl[0], SRV_TASK_NORMAL_PRIO, SRV_MSQ_ENABLE},
	{TID_SNIFFER_2, "TEST_SNIFFER_2", sniffer_entry, &g_astTaskTbl[1], SRV_TASK_NORMAL_PRIO, SRV_MSQ_ENABLE},
	{TID_SNIFFER_3, "TEST_SNIFFER_3", sniffer_entry, &g_astTaskTbl[2], SRV_TASK_NORMAL_PRIO, SRV_MSQ_ENABLE},
	{TID_SNIFFER_4, "TEST_SNIFFER_4", sniffer_entry, &g_astTaskTbl[3], SRV_TASK_NORMAL_PRIO, SRV_MSQ_ENABLE},
	{TID_SNIFFER_5, "TEST_SNIFFER_5", sniffer_entry, &g_astTaskTbl[4], SRV_TASK_NORMAL_PRIO, SRV_MSQ_ENABLE}
