...
/* Ranges. */
#define OFPP_MAX        OFP_PORT_C(0xff10) /* Max # of switch ports. */
...
#define OFPP_MAX_1      OFP_PORT_C(0xff01) /*In-house controller action port 1*/
#define OFPP_MAX_2      OFP_PORT_C(0xff02) /*In-house controller action port 2*/
#define OFPP_MAX_3      OFP_PORT_C(0xff03) /*In-house controller action port 3*/
#define OFPP_MAX_4      OFP_PORT_C(0xff04) /*In-house controller action port 4*/
#define OFPP_MAX_5      OFP_PORT_C(0xff05) /*In-house controller action port 5*/
#define OFPP_MAX_6      OFP_PORT_C(0xff06) /*In-house controller action port 6*/
#define OFPP_MAX_7      OFP_PORT_C(0xff07) /*In-house controller action port 7*/
#define OFPP_MAX_8      OFP_PORT_C(0xff08) /*In-house controller action port 8*/
#define OFPP_MAX_9      OFP_PORT_C(0xff09) /*In-house controller action port 9*/
#define OFPP_MAX_10     OFP_PORT_C(0xff0a) /*In-house controller action port 10*/
#define OFPP_MAX_11     OFP_PORT_C(0xff0b) /*In-house controller action port 11*/
#define OFPP_MAX_12     OFP_PORT_C(0xff0c) /*In-house controller action port 12*/
#define OFPP_MAX_13     OFP_PORT_C(0xff0d) /*In-house controller action port 13*/
#define OFPP_MAX_14     OFP_PORT_C(0xff0e) /*In-house controller action port 14*/
#define OFPP_MAX_15     OFP_PORT_C(0xff0f) /*In-house controller action port 15*/
